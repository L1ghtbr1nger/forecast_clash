$('document').ready(function() {
    ...
    $.each(pendingLocations, function(i, v) {
        ...
        }).bindPopup('Pending ' + pendingEvents[i] + ' Forecast at <br><strong> ' + v[0] + ',' + v[1] + '</strong> starting</br>' + pendingDates[i] + ' UTC</br><a style="text-decoration: underline;color:rgb(61, 182, 239)" id="deletePending" href="">Delete<input id="toDelete" name="toDelete" type="hidden" value="'+pendingIDs[i]+'"></a>').openPopup());
    });
