...
class TeamsusersController extends AppController
{
     ...
     * View method
     *
     * @param string|null $id Teamsuser id.
     * @return \Cake\Network\Response|null
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Teamsusers->save($teamsuser)) {
                $this->Flash->success(__('The teamsuser has been saved.'));

                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error(__('The teamsuser could not be saved. Please, try again.'));
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Teamsusers->delete($teamsuser)) {
            $this->Flash->success(__('The teamsuser has been deleted.'));
        } else {
            $this->Flash->error(__('The teamsuser could not be deleted. Please, try again.'));
        }
