                        ...
                        <tbody>
                            ...
                            foreach ($teammates as $teammate) {
                                foreach ($teammate['users'] as $user) {
                                    ...
                                    echo '<td>'.$this->Html->image($user['avatar']['avatar_img'],['style' => 'max-width:35px;max-height:35px;margin-right:4px']).' '.h($user['first_name']).' '.h($user['last_name']).'</td>';
                        ...
                        <tbody>
                            ...
                            if ($rankResult) {
                                ...
                                foreach ($rankings as $rank) {
                                    ...
                                    echo '<td>'.(isset($rank['team_logo']) ? $this->Html->image('teams/users/'.$rank['team_logo'], ['style' => 'max-width: 75px; max-height: 75px; padding-right:4px']) : $this->Html->image('logo-mark.png', ['style' => 'max-width: 75px; max-height: 75px'])).' '.h($rank['team_name']).'</td>';
