...
class HistoricalForecastsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'longitude' => ['type' => 'float', 'length' => 7, 'precision' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        'forecast_date_start' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'forecast_date_end' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'radius' => 1,
            'weather_event_id' => 1,
            'forecast_date_start' => '2017-03-25 21:54:56',
            'forecast_date_end' => '2017-03-25 21:54:56',
            'forecast_length' => 1,
            'admin_event_id' => 1,
            'correct' => 1
        ],
